...
weight: 5
description: "This is the fastest first-agent success path when you do not have a provider key"
---
...
[Your First Agent](your-first-agent). The command shape is the same, but a
...
[Debugging your agent](debugging-agents) for provider checks, run history,
