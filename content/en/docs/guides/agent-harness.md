...
The "in progress" rows are exactly the roadmap's [Now and Next](/docs/roadmap),
...
- [Agent Loops](agent-loops) — run-until-done, with a ceiling
- [Plan & Delegate](plan-delegate)
- [Agent Guardrails](agent-guardrails)
- [Provider Conformance](provider-conformance) — verified provider behavior
