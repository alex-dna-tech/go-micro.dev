...
weight: 1
draft: true
description: "go-micro is designed for developer productivity and ease of use while maintaining good performance for most use cases. This document explains the performance characteristics and trade-offs."
---
...
- [Reflection Removal Analysis](reflection-removal-analysis) - Detailed technical analysis
- [Architecture](architecture) - go-micro design principles
